...
part 'earn_rule.g.dart';

abstract class EarnRule implements Built<EarnRule, EarnRuleBuilder> {
    ...
    static void _initializeBuilder(EarnRuleBuilder b) => b;

    factory EarnRule([void updates(EarnRuleBuilder b)]) = _$EarnRule;

    @BuiltValueSerializer(custom: true)
    static Serializer<EarnRule> get serializer => _$EarnRuleSerializer();
}

class _$EarnRuleSerializer implements StructuredSerializer<EarnRule> {

    @override
    final Iterable<Type> types = const [EarnRule, _$EarnRule];
    @override
    final String wireName = r'EarnRule';

    @override
    Iterable<Object> serialize(Serializers serializers, EarnRule object,
    ...
    @override
    EarnRule deserialize(Serializers serializers, Iterable<Object> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = EarnRuleBuilder();

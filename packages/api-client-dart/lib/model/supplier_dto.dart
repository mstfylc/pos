...
abstract class SupplierDto implements Built<SupplierDto, SupplierDtoBuilder> {
    ...
    static void _initializeBuilder(SupplierDtoBuilder b) => b;

    factory SupplierDto([void updates(SupplierDtoBuilder b)]) = _$SupplierDto;

    @BuiltValueSerializer(custom: true)
    static Serializer<SupplierDto> get serializer => _$SupplierDtoSerializer();
}

class _$SupplierDtoSerializer implements StructuredSerializer<SupplierDto> {

    @override
    final Iterable<Type> types = const [SupplierDto, _$SupplierDto];
    @override
    final String wireName = r'SupplierDto';

    @override
    Iterable<Object> serialize(Serializers serializers, SupplierDto object,
    ...
    @override
    SupplierDto deserialize(Serializers serializers, Iterable<Object> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = SupplierDtoBuilder();

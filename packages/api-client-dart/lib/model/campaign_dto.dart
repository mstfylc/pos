...
abstract class CampaignDto implements Built<CampaignDto, CampaignDtoBuilder> {
    ...
    static void _initializeBuilder(CampaignDtoBuilder b) => b;

    factory CampaignDto([void updates(CampaignDtoBuilder b)]) = _$CampaignDto;

    @BuiltValueSerializer(custom: true)
    static Serializer<CampaignDto> get serializer => _$CampaignDtoSerializer();
}

class _$CampaignDtoSerializer implements StructuredSerializer<CampaignDto> {

    @override
    final Iterable<Type> types = const [CampaignDto, _$CampaignDto];
    @override
    final String wireName = r'CampaignDto';

    @override
    Iterable<Object> serialize(Serializers serializers, CampaignDto object,
    ...
    @override
    CampaignDto deserialize(Serializers serializers, Iterable<Object> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = CampaignDtoBuilder();

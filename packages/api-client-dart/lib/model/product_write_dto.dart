...
part 'product_write_dto.g.dart';

abstract class ProductWriteDto implements Built<ProductWriteDto, ProductWriteDtoBuilder> {
    ...
    static void _initializeBuilder(ProductWriteDtoBuilder b) => b;

    factory ProductWriteDto([void updates(ProductWriteDtoBuilder b)]) = _$ProductWriteDto;

    @BuiltValueSerializer(custom: true)
    static Serializer<ProductWriteDto> get serializer => _$ProductWriteDtoSerializer();
}

class _$ProductWriteDtoSerializer implements StructuredSerializer<ProductWriteDto> {

    @override
    final Iterable<Type> types = const [ProductWriteDto, _$ProductWriteDto];
    @override
    final String wireName = r'ProductWriteDto';

    @override
    Iterable<Object> serialize(Serializers serializers, ProductWriteDto object,
    ...
    @override
    ProductWriteDto deserialize(Serializers serializers, Iterable<Object> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = ProductWriteDtoBuilder();

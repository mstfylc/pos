...
class AuthApi {
  ...
  ///
  /// 
  Future<Response<AuthTokenResult>> apiV1AuthLoginPost(
    ...
    const _responseType = FullType(AuthTokenResult);
    final _responseData = _serializers.deserialize(
      _response.data,
      specifiedType: _responseType,
    ) as AuthTokenResult;

    return Response<AuthTokenResult>(
      data: _responseData,
  ...
  ///
  /// 
  Future<Response<OtpResult>> apiV1AuthOtpRequestPost(
    ...
    final _request = RequestOptions(
      path: r'/api/v1/auth/otp/request',
      method: 'POST',
      headers: <String, dynamic>{
        ...?headers,
      },
    ...
    const _responseType = FullType(OtpResult);
    final _responseData = _serializers.deserialize(
      _response.data,
      specifiedType: _responseType,
    ) as OtpResult;
  ...
  ///
  /// 
  Future<Response<OtpResult>> apiV1AuthOtpVerifyPost(
  ...
  ///
  /// 
  Future<Response<AuthTokenResult>> apiV1AuthRefreshPost(

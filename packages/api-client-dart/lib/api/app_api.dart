...
class AppApi {
  ...
  ///
  /// 
  Future<Response<CancelOrderResponse>> cancelAppOrder(
    String orderId,
  ...
  ///
  /// 
  Future<Response<OrderResponse>> createAppOrder(
  ...
  ///
  /// 
  Future<Response<BuiltList<Category>>> listAppCategories(
    String companyId, { 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
  ...
  ///
  /// 
  Future<Response<BuiltList<Customer>>> listAppCustomers(
    String companyId, { 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
  ...
  ///
  /// 
  Future<Response<BuiltList<Discount>>> listAppDiscounts(
    String companyId, { 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
  ...
  ///
  /// 
  Future<Response<BuiltList<OrderListItem>>> listAppOrders(
    String companyId, { 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
  ...
  ///
  /// 
  Future<Response<BuiltList<Pos>>> listAppPos(
    String companyId, { 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
  ...
  ///
  /// 
  Future<Response<BuiltList<Product>>> listAppProducts(
    String companyId, { 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
  ...
  ///
  /// 
  Future<Response<BuiltList<Store>>> listAppStores(
    String companyId, { 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
  ...
  ///
  /// 
  Future<Response<CancelOrderResponse>> refundAppOrder(
    String orderId,
    ReasonRequest reasonRequest, { 
    CancelToken cancelToken,
    Map<String, dynamic> headers,

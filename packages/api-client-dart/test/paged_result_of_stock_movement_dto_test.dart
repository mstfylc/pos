...
// tests for PagedResultOfStockMovementDto
void main() {
  final instance = PagedResultOfStockMovementDtoBuilder();
  // TODO add properties to the builder and call build()

  group(PagedResultOfStockMovementDto, () {
    // BuiltList<StockMovementDto> items

...
// tests for PurchaseWriteDto
void main() {
  final instance = PurchaseWriteDtoBuilder();
  // TODO add properties to the builder and call build()

  group(PurchaseWriteDto, () {
    // String companyId
    ...
    test('to test the property `purchaseTime`', () async {
      // TODO
    });
    ...
    test('to test the property `paymentCompleted`', () async {
      // TODO
    });
    ...
    // BuiltList<PurchaseLineWriteDto> lines

...
// tests for StoreProductTransferLine
void main() {
  final instance = StoreProductTransferLineBuilder();
  // TODO add properties to the builder and call build()

  group(StoreProductTransferLine, () {
    // String id
    ...
    test('to test the property `receivedQuantity`', () async {
      // TODO
    });

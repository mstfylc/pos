...
// tests for IdentifiedCustomer
void main() {
  final instance = IdentifiedCustomerBuilder();
  // TODO add properties to the builder and call build()

  group(IdentifiedCustomer, () {
    // String customerId
    ...
    test('to test the property `walletBalance`', () async {
      // TODO
    });
    ...
    // String tierName
    test('to test the property `tierName`', () async {
      // TODO
    });

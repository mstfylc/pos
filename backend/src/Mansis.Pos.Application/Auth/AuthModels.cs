...
public sealed record AuthTokenResult(Guid UserId, Guid CompanyId, string AccessToken, string RefreshToken, DateTimeOffset ExpiresAt, bool MustChangePassword);
...
public sealed record AuthUserSnapshot(Guid Id, Guid CompanyId, string Username, byte[] PasswordHash, byte[] PasswordSalt, bool Active, bool MustChangePassword);
